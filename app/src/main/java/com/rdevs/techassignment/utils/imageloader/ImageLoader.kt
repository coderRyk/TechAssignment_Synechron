package com.rdevs.techassignment.utils.imageloader
...
class ImageLoader(context: Context) {
    ...
    init {
        ...
        executorService = Executors.newCachedThreadPool(Utils.ImageThreadFactory())
    ...
    private fun loadImageIntoImageView(imageView: ImageView, bitmap: Bitmap?, imageUrl: String) {
        ...
        Log.d("loadImageIntoImageView", imageUrl)
